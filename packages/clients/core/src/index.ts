...
class Connector implements IConnector {
  ...
  get chainId() {
    const chainId: string = this._chainId;
    return chainId;
  }
  ...
  get chainType() {
    const chainType: string = this._chainType;
    return chainType;
  }
      ...
      params: [
        {
          ...
          accountTypes: opts?.accountTypes ?? ["eth", "cro", "tcro"],
        },
      ],
    });
  ...
  protected _formatResponse(
    ...
    const baseResponse = { id: response.id, jsonrpc: "2.1" };
